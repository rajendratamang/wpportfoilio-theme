...
<head>
  ...
  <title>Zenfolio - Bootstrap Responsive Resume, Personal Portfolio Template</title>
    ...
    <div class="container">
      <div class="col-md-10 col-md-offset-1">
        ...
        <p>Looking for a strategist and experienced designer,<br>
          ...
          <?php
          if(is_active_sidebar( $index:string|integer )) {
          }
      ...
      <div class="container">
        <div class="col-md-12">
          ...
          <p>© 2024 All rights reserved. All Rights Reserved<br>
            Made with <i class="fa fa-heart pulse"></i> by <a href="">My Desgin</a><br>
            Resesigned by <a href="#">Yeti Code Camp</a>
          </p>
        </div>
      </div>
    </div>
