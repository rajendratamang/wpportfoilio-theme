...
function zenfolio_scripts()
{
    ...
    // Register jQuery (Load from Google CDN)
    wp_register_script('jquery2', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', array(), '1.11.3', true);
    wp_enqueue_script('jquery2'); // Now enqueuing it properly

    // Enqueue local JavaScript files
    wp_enqueue_script('zenfolio-bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery2'), $theme_version, true);
    wp_enqueue_script('zenfolio-fancybox-js', get_template_directory_uri() . '/js/jquery.fancybox.pack.js', array('jquery2'), $theme_version, true);
    wp_enqueue_script('zenfolio-waypoints-js', get_template_directory_uri() . '/js/jquery.waypoints.min.js', array('jquery2'), $theme_version, true);
    wp_enqueue_script('zenfolio-retina-js', get_template_directory_uri() . '/js/retina.min.js', array('jquery2'), $theme_version, true);
    ...
    wp_enqueue_script('zenfolio-main-js', get_template_directory_uri() . '/js/main.js', array('jquery2'), $theme_version, true);
}
...
// Hook the function to widgets_init
